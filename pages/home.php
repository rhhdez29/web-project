...
<body>
    ...
    <?php foreach($apuntes as $apunte): ?>
        <div class="tarjeta apunte">
            <a href="apuntes.php?id=<?php echo $apunte['id']; ?>">
                <h3><?php echo htmlspecialchars($apunte['titulo']); ?></h3>
                <p>Creado: <?php echo date('d/m/Y', strtotime($apunte['fecha_creacion'])); ?></p>
            </a>
        </div>
    <?php endforeach; ?>
</div>
